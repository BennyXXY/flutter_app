...
import 'package:flutterapp/barrage/barrage.dart';
import 'package:flutterapp/barrage/huya_barrage.dart';
...
class BarrageTest extends StatefulWidget {
  @override
  _BarrageTestState createState() => _BarrageTestState();
}

class _BarrageTestState extends State<BarrageTest> {
                  ...
                  onPressed: () {
                    ...
                    _timer = Timer.periodic(
                      ...
                      (timer) {
                        ...
                        int _random = random.nextInt(valuse.length);
                        var text = valuse[_random];
                        var child;
                        if (_random == 1) {
