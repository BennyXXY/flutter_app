...
class ACEMarqueePage extends StatefulWidget {
  @override
  _ACEMarqueePageState createState() => _ACEMarqueePageState();
}
...
class _ACEMarqueePageState extends State<ACEMarqueePage> {
  ...
  Widget _marqueeWid03() {
    return Container(
        child: Marquee(children: <Widget>[
      Container(height: 100,width: 100, child: Image.asset('assets/image/guide_1.png')),
      Container(height: 100,width: 100, child: Image.asset('assets/image/guide_2.png')),
      Container(height: 100,width: 100, child: Image.asset('assets/image/guide_1.png')),
      Container(height: 100,width: 100, child: Image.asset('assets/image/guide_2.png')),
      Container(height: 100,width: 100, child: Image.asset('assets/image/guide_1.png')),
      Container(
    ...
    ], direction: AxisDirection.left, duration: Duration(milliseconds: 2000),onItemTap: (index){
          setState(() {
            print('==========$index');
          });
        },));
